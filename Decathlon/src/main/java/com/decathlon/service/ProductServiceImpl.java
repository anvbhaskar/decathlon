...
public class ProductServiceImpl implements ProductService {
	...
	@Override
	public List<ProductDto> fetchProductDetailsByStoreId(Integer productId, Integer storeId) {
		
		List<ProductDto> productDto=new ArrayList<ProductDto>();
		List<Product> productList=productDao.fetchProductDetailsByStoreId(productId, storeId);
		
		//productList.stream().map(productDto -> new ProductDto(productDto.getProductName(),productDto.getProductLevel(),productDto.getProductSport())).collect(Collectors.toList());
